...
@Component(
	...
	service = ServerStatistics.class
)
public class ServerStatistics
	...
	public void processDataSample(
		...
		CompanyStatistics companyStatistics = ServerStaticsUtil.
		...
		if (companyStatistics == null) {
			try {
				...
				companyStatistics = ServerStaticsUtil.register(company.getWebId(), _companyLocalService);
			}
