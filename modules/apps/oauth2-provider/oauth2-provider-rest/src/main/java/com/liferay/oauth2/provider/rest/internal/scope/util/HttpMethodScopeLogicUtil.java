...
public class HttpMethodScopeLogicUtil {
	...
	public static boolean check(
		...
		try {
			...
			ScopeFinder scopeFinder = _bundleContext.getService(
				_getServiceReference(applicationName, ScopeFinder.class, _bundleContext));
	...
	private static <T> ServiceReference<? extends T> _getServiceReference(
			String applicationName, Class<? extends T> clazz, BundleContext bundleContext)
		throws Exception {
	...
	public static Set<String> setIgnoreMissingScopes(Map<String, Object> properties){
