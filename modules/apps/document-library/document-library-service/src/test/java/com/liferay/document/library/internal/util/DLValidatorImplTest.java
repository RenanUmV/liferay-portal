...
public class DLValidatorImplTest {
	...
	public void setUp() {
		...
		_dlSizeLimitHelper = Mockito.mock(DLSizeLimitHelper.class);

		dlValidatorImpl.setDLSizeLimitManagedServiceFactory(_dlSizeLimitHelper);
	...
	public void testCompanyMimeTypeSizeLimitTakesPrecedenceOverGroupMimeTypeSizeLimit()
		...
		Mockito.when(
			_dlSizeLimitHelper.getCompanyMimeTypeSizeLimit(
		...
		Mockito.when(
			_dlSizeLimitHelper.getGroupMimeTypeSizeLimit(
				Mockito.anyLong(), Mockito.anyString())
		).thenReturn(
			15L
		);
	...
	public void testMaxAllowableSizeDLFileMaxSizeTakesPrecedenceOverMimeTypeSizeLimit()
		...
		Mockito.when(
			_dlSizeLimitHelper.getCompanyFileMaxSize(Mockito.anyLong())
		).thenReturn(
			10L
		);
